    ...
    <>
      <Section surface="paper-50" className="border-b border-border">
        <Container className={series.image ? 'grid gap-8 lg:grid-cols-[1.2fr_1fr] lg:items-center' : ''}>
          <div>
            <p className="mb-2 text-tiny uppercase tracking-caps text-red-600">Series</p>
            <h1 className="text-h1">{series.title}</h1>
            {series.description ? <p className="mt-3 max-w-prose text-lead text-charcoal-700">{series.description}</p> : null}
